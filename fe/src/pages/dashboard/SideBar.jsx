...
const Sidebar = ({ isSidebarOpen, toggleSidebar }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className={`fixed md:relative w-64 bg-white shadow-lg h-screen p-4 z-50 transform transition-transform duration-300 ease-in-out ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'}`}>
        ...
        <ul className="space-y-2 text-base text-gray-700 font-semibold">
          ...
          <li>
            <Link
              to="/"
              className={`flex justify-between items-center w-full p-2 rounded-lg hover:bg-gray-100 ${activeMenu === "dashboard" ? "bg-purple-100 text-blue-500" : ""}`}
          ...
          <li>
            <button
              ...
              className={`flex justify-between items-center w-full p-2 rounded-lg hover:bg-gray-100 ${
                activeMenu === "companyInfo" ? "bg-purple-100 text-blue-500" : ""
              }`}
            >
              <div className="flex items-center">
                <IoNewspaperOutline />
            ...
            {openMenus["companyInfo"] && (
              <ul className="ml-4 mt-1 space-y-1 text-gray-600 text-sm">
                ...
                <li
                  className={`p-2 rounded-lg hover:bg-gray-100 ${
                    activeMenu === "favicon" ? "bg-purple-100 text-blue-500" : ""
                  }`}
