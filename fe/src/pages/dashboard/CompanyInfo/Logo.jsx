...
export const Logo = () => {
  ...
  useEffect(() => {
    if (logo && logo.url) {
      setPreviewImage(getImgUrl(logo.url));
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600 mt-1">
                        Tải lên và quản lý logo cho website của bạn
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="border-b border-gray-200 bg-gray-50 px-6 py-4">
                    <div className="flex items-center justify-between mb-6">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 mt-1">
                          So sánh logo hiện tại và logo mới trước khi cập nhật
                        </p>
                      </div>
                        ...
                        {logo && logo.url ? (
                          ...
                          <div className="text-center space-y-3 text-gray-400">
                            ...
                            <div className="space-y-1">
                              ...
                              <p className="text-xs">Tải lên logo đầu tiên</p>
                            </div>
                          </div>
                        )}
                      </div>
                      ...
                      {previewImage && !isServerImage && (
                        <div className="mt-4 bg-blue-50 rounded-lg p-3 border border-blue-200">
                          <div className="flex items-center space-x-2 text-blue-800">
                            ...
                            <span className="text-sm font-medium">
                              Logo mới đã sẵn sàng để cập nhật
                            </span>
                          </div>
                        </div>
                      )}
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                      <div className="flex-1">
                        <p className="text-sm text-gray-600">
                          {previewImage && !isServerImage
                            ? "Kiểm tra kỹ logo mới trước khi cập nhật"
                            : "Chọn logo mới để bắt đầu so sánh"}
                        </p>
                      </div>
                      <div className="flex-shrink-0">
                        <button
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <ul className="text-sm text-blue-700 mt-1 list-disc list-inside space-y-1">
                ...
                <li>
                  Nên sử dụng ảnh có nền trong suốt (PNG) để hiển thị tốt nhất
                </li>
                <li>Tỷ lệ khung hình phù hợp: 2:1 hoặc 3:1</li>
              </ul>
            </div>
          </div>
        </div>
